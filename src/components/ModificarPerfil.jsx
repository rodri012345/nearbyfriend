    ...
    <div>
     ...
     <div className='ModificarContainer'>
        <div className='FotosContainer'>
              <div className='fila'><h2>Actualizar Imagenes de perfil</h2></div>
                <div className='fila'>    {/*este contenido tendra la edicion de imagenes */}         
                  <div className='columna'>
                    ...
                    />
                    <button className='BtnImagen'>Actualizar Imagen</button>
                  </div>
                  <div className='columna'>
        ...
        <div className='DatosEditarContainer'>
            <div className='fila'><h2>Actualizar datos </h2></div>
          <div className='fila'>{/* esto sera para modificar los datos personales */}
        ...
        <div className='HobbiesDescripcionContainer'>
          <div className='Row'>
