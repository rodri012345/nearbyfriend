      ...
      >
        <Form form={form} layout="vertical" onFinish={onFinish}>
          <Form.Item
            ...
            rules={[
              { required: true, message: 'Por favor ingresa la nueva descripcion' },
              { whitespace: true },
              { min: 30, message: "La Descripcion debe tener al menos 30 caracteres" },
              { max: 150, message: "La Descripcion no puede tener más de 150 caracteres" }
